...
function HydraLib.CreateButton(buttonText, position, callback, targetPage)
	local button = Instance.new("TextButton")
	button.Size = UDim2.new(0, 200, 0, 50)
	button.Position = position or UDim2.new(0, 100, 0, 100)
	button.Text = buttonText or "Click Me"
	button.Parent = targetPage or mainGui  -- Place button in targetPage, or default to mainGui
