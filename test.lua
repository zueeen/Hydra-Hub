...
function HydraLib.CreatePageSystem()
	...
	-- Top Bar (permanent, not page-bound)
	...
	local function createPage(name)
		...
		page.Name = name
		page.Size = UDim2.new(1, -60, 1, -40) -- adjusted height to account for top bar
		page.Position = UDim2.new(0, 60, 0, 35) -- offset for top bar height
